...
class GeoFunctions {
     ...
     * @return array
     */
    public static function getCountries (string $code = '') : array | string
    {
     ...
     * @return string
     */
    public static function getLanguageName (string $locale)
    {
     ...
     * @return int
     */
    public static function getVAT ($countryCode)
    {
     ...
     * @return array
     */
    public static function getUserLocation (string $ip)
    {
